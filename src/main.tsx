...
const DiscoveryPage = lazy(() => import("./pages/studio/discovery.tsx"));
...
const SystemHealthPage = lazy(() => import("./pages/studio/system.tsx"));
const SettingsPage = lazy(() => import("./pages/studio/settings.tsx"));
